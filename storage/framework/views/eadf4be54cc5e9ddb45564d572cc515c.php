        ...
        <form action="<?php echo e(route('post.update', $post->id)); ?>" method="POST">  
            ...
            <div class="mb-5">  
                ...
                <input type="text" class="  
                    form-control                    block                    w-full                    px-3                    py-1.5                    text-base                    font-normal                    text-gray-700                    bg-white bg-clip-padding                    border border-solid border-gray-300                    rounded-full                    transition                    ease-in-out                    m-0                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none                  " name="title" value="<?php echo e(old('title', $post->title)); ?>" required>  
...
unset($__errorArgs, $__bag); ?>  
            ...
            <div class="mb-5">  
                ...
                <select name="status" class="form-select appearance-none  
                    ...
                    <option value="1" <?php echo e(old('status', $post->status) == 1 ? 'selected':''); ?> >Publish</option>  
...
</html><?php /**PATH C:\xampp816\htdocs\blog\resources\views/posts/edit.blade.php ENDPATH**/ ?>